...
//             viewport={{ once: true }}
//           >
//             <h1 className="text-4xl sm:text-5xl font-bold uppercase tracking-wide text-gradient bg-clip-text text-transparent bg-gradient-to-r from-pink-400 via-rose-400 to-amber-300">
//               Hi, I’m <span className="text-amber-200">Dhruv Sharma</span>
//             </h1>

//             <div className="min-h-[1.8rem] sm:min-h-[5rem]">
...
//                 {text}
//                 <Cursor cursorStyle="|" className="text-amber-200" />
//               </p>
//             </div>
