...
const education = [
  {
    ...
    icon: (
      <FaCertificate className="text-yellow-400 text-2xl sm:text-3xl mb-2" />
    ),
    skills: [
      {
        name: "MS Office",
        icon: (
          <AiFillFileText className="text-yellow-400 text-xl sm:text-2xl mr-1" />
        ),
      },
    ],
  },
  {
    ...
    icon: (
      <FaGraduationCap className="text-indigo-400 text-2xl sm:text-3xl mb-2" />
    ),
    skills: [],
  },
  {
    ...
    skills: [
      {
        name: "C",
        icon: (
          <SiCplusplus className="text-blue-500 text-xl sm:text-2xl mr-1" />
        ),
      },
      {
        name: "C++",
        icon: (
          <SiCplusplus className="text-[#00599C] text-xl sm:text-2xl mr-1" />
        ),
      },
      {
        name: "Java",
        icon: <FaJava className="text-[#1283da] text-xl sm:text-2xl mr-1" />,
      },
      { name: "Tally ERP" },
      {
        name: "Photoshop",
        icon: (
          <SiAdobephotoshop className="text-blue-400 text-xl sm:text-2xl mr-1" />
        ),
      },
      { name: "PageMaker" },
      {
        name: "CorelDraw",
        icon: (
          <SiCoreldraw className="text-orange-500 text-xl sm:text-2xl mr-1" />
        ),
      },
      {
      ...
      {
        name: "Basic Java",
        icon: <SiCplusplus className="text-red-400 text-xl sm:text-2xl mr-1" />,
      },
      {
        name: "Oracle DB",
        icon: <SiOracle className="text-red-600 text-xl sm:text-2xl mr-1" />,
      },
    ],
  },
  {
    ...
    skills: [
      {
        name: "HTML",
        icon: <FaHtml5 className="text-orange-500 text-xl sm:text-2xl mr-1" />,
      },
      {
        name: "CSS",
        icon: <FaCss3Alt className="text-blue-500 text-xl sm:text-2xl mr-1" />,
      },
      {
        name: "JavaScript",
        icon: <FaJs className="text-yellow-400 text-xl sm:text-2xl mr-1" />,
      },
      {
        name: "React",
        icon: <FaReact className="text-cyan-400 text-xl sm:text-2xl mr-1" />,
      },
      {
        name: "Node.js",
        icon: <FaNodeJs className="text-green-500 text-xl sm:text-2xl mr-1" />,
      },
      {
        name: "Express.js",
        icon: <SiExpress className="text-gray-300 text-xl sm:text-2xl mr-1" />,
      },
      {
        name: "MongoDB",
        icon: <SiMongodb className="text-green-400 text-xl sm:text-2xl mr-1" />,
      },
      {
        name: "TailwindCSS",
        icon: (
          <SiTailwindcss className="text-sky-400 text-xl sm:text-2xl mr-1" />
        ),
      },
      {
        name: "AWS",
        icon: <FaAws className="text-orange-400 text-xl sm:text-2xl mr-1" />,
      },
      {
        name: "REST API",
        icon: (
          <BiNetworkChart className="text-pink-400 text-xl sm:text-2xl mr-1" />
        ),
      },
      {
        name: "Git/GitHub",
        icon: <FaGit className="text-white text-xl sm:text-2xl mr-1" />,
      },
    ],
  },
];
